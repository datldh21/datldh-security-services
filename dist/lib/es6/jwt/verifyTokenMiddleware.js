...
export var verifyTokenMiddleware = function (req, res, next, REFRESH_TOKEN_SECRET, ACCESS_TOKEN_MAXAGE, REFRESH_TOKEN_MAXAGE) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            case 0:
                verifyAccessToken = function (_a) {
                    ...
                    var userObj = jwtDecodeToken(token, jwtSecret);
                    var verify = jwt.verify(token, jwtSecret);
            ...
            case 1:
                ...
                return [4 /*yield*/, handleRefreshToken({
                        req: req,
                        res: res,
                        refreshTokenSecret: REFRESH_TOKEN_SECRET,
                        accessTokenMaxAge: ACCESS_TOKEN_MAXAGE !== null && ACCESS_TOKEN_MAXAGE !== void 0 ? ACCESS_TOKEN_MAXAGE : Config.ACCESS_TOKEN_MAXAGE,
                        refreshTokenMaxAge: REFRESH_TOKEN_MAXAGE !== null && REFRESH_TOKEN_MAXAGE !== void 0 ? REFRESH_TOKEN_MAXAGE : Config.REFRESH_TOKEN_MAXAGE,
                    })];
            case 2:
                check = _a.sent();
                if (check) {
